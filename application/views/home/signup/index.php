                    ...
                    <article class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="" true=""
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="" true=""
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="password" name="password" class="form-control" placeholder="" true=""
                                        required="">
                                    <?= form_error('password', '<small class="text-danger pl-2"><i>', '</i></small>'); ?>
                                </div>
                                <div class="form-group col-md-6">
                                    <label><span class="text-danger">* </span>Konfirmasi Password</label>
                                    <input type="password" name="passwordc" class="form-control" placeholder="" true=""
                                        required="">
                            ...
                            <!-- <div class="form-row">
                                <div class='form-group col-md-6'>
                                    ...
                                    <select class='form-control' id='provinsi' name="prov">
                                        ...
                                        <?php
											...
											// echo "<option value='$prov[id]'>$prov[province]</option>";
											// }
											?>
                                    </select>
                                </div>
                                <div class='form-group col-md-6'>
                                    ...
                                    <select class='form-control' id='kabupaten-kota' name="kab">
                                        <option value='0'>--pilih--</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class='form-group col-md-6'>
                                    ...
                                    <select class='form-control' id='kelurahan-desa' name="kel">
                                        <option value='0'>--pilih--</option>
                                    </select>
                                </div>
                            </div> -->

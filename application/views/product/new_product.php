                     ...
                     <form action="<?= base_url('product/addproduct') ?>" method="post"  enctype="multipart/form-data">
                        <div class="form-row">
                           <div class="form-group  col-md-8">
                              ...
                              <input type="text" class="form-control" id="product" name="product" placeholder="Product Name" value="<?= set_value('product')?>" />
                              <?= form_error('product','<small class="text-danger pl-1">','</small>')?>
                           </div>
                           <div class="form-group col-md-4">
                              <label class="col-form-label"  for="stock">Stock</label>
                              <input type="number" class="form-control" id="stock" name="stock" placeholder="0" value="<?= set_value('stock')?>" />
                        ...
                        <div class="form-row">
                           <div class="form-group col-md-5">
                              ...
                              <input type="number" class="form-control" id="price" name="price" placeholder="Before Discount" value="<?= set_value('price')?>" />
                              <?= form_error('price','<small class="text-danger pl-1">','</small>')?>
                           </div>
                           <div class="form-group col-md-2">
                              <label class="col-form-label"  for="discount" >Discount %</label>
                              <input type="number" data-toggle="tooltip" title="Enter '0' if you don't have a discount" class="form-control" id="discount"  name="discount"  placeholder="%"  />
                              <?= form_error('discount','<small class="text-danger pl-1">','</small>')?>
                           </div>
                           <div class="form-group col-md-5">
                              <label class="col-form-label"  for="price_total">Price Total Rp.</label>
                              <input type="number" class="form-control" readonly=""  id="price_total" name="price_total" placeholder="After discount" value="<?= set_value('price_total')?>" />
                        ...
                        <div class="form-group row mb-4">
                           <div class="col-12">
                              ...
                              <textarea class="summernote" id="description" name="description" value="<?= set_value('description')?>"><?= set_value('description')?></textarea>
                        ...
                        <div class="form-group row mb-4">
                           ...
                           <div class="col-3 mr-0">
                              <img src="#" class=" mx-auto rounded img-fluid img-thumbnail" width="200"   alt="Product Image">
                           </div>
                        </div>
                        <div class="form-group row mb-4">
